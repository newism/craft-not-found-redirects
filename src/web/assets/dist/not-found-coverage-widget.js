...
Newism.notFoundRedirects.NotFoundCoverageWidget = Garnish.Base.extend({
    init: function (widgetId, settings) {
        ...
        Craft.sendActionRequest('POST', 'not-found-redirects/not-found-uris/coverage-chart-data', {
            data: {
